...
public class Logger : MonoBehaviour
{
    ...
    public void LogStartTest(int index, string correctionMode, string structure, string masses)
    {
        string eventDescription = $"The subject has begun task {index} using mode {correctionMode}, structure {structure} and masses {masses}.";
        LogEvent("TS", eventDescription);
    }

    public void LogEndTest(int index)
    {
        string eventDescription = $"The subject has finished task {index}.";
        LogEvent("TE", eventDescription);
    }

    public void LogDifficultyOfTask(int index, int value)
    {
        string eventDescription = $"The subject stated that task {index} was {value} in difficulty";
        LogEvent("QD", eventDescription);
    }

    public void LogHeaviestBlock(int index, int value)
    {
        string eventDescription = $"The subject stated that in task {index} {value} was the heaviest";
        LogEvent("QH", eventDescription);
    }

    public void LogLightestBlock(int index, int value)
    {
